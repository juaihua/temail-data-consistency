...
//  private final JsonConverter<ListenerEvent> jsonConverter = Mockito.mock(JsonConverter.class);
//
//  private final ListenerEventService  listenerEventService= new ListenerEventService(taskExecutor,mqProducer,listenerEventRepo,jsonConverter);
